...
# Read the dataset
df = pd.read_csv(r"C:\Users\umesh\Downloads\MapUp-Data-Assessment-F-main\MapUp-Data-Assessment-F-main\datasets\dataset-3.csv")
...
print("Calculate Time-Based Toll Rates: Adjusting Rates for Different Time Intervals")
